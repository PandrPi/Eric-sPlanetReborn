...
{
	[Serializable]
	public struct SimplexNoise : IGenerationNoise
	{
		...
		/// <summary>
		/// Calculates the Simplex noise value for the specified vector
		/// </summary>
		...
		/// <summary>
		/// Calculates Fractional Brownian Motion of the Simplex noise for the specified vector
		/// </summary>
		/// <param name="x">Vector for which the noise value should be calculated</param>
		...
		/// <returns>Returns a fractal sum of Simplex noise values</returns>
